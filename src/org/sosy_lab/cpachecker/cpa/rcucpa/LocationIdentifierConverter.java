  ...
  public static RCUMemoryLocation toLocation(AbstractIdentifier id) {
    if (id instanceof LocalVariableIdentifier) {
      ...
      if (owner != null) {
        ...
        return RCUMemoryLocation.valueOf(ownerType + "." + stfid.getName());
      } else {
        return RCUMemoryLocation.valueOf(stfid.toString());
      }
      ...
      if (owner != null) {
        ...
        return RCUMemoryLocation.valueOf(ownerType + "." + stid.getName());
      } else {
        return RCUMemoryLocation.valueOf(stid.toString());
      }
