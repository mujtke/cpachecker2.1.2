...
import org.sosy_lab.cpachecker.cpa.pointerOld.PointerDomain;
import org.sosy_lab.cpachecker.cpa.pointerOld.PointerState;
import org.sosy_lab.cpachecker.cpa.pointerOld.PointerStatistics;
...
public class RCUSearchState extends AbstractSingleWrapperState
  ...
  private final ImmutableSet<RCUMemoryLocation> rcuPointers;

  public RCUSearchState(ImmutableSet<RCUMemoryLocation> pointers, PointerState pPointerState) {
    super(pPointerState);
  ...
  public Set<RCUMemoryLocation> getRcuPointers() {
    return rcuPointers;
  }
  ...
  public Map<RCUMemoryLocation, Set<RCUMemoryLocation>> getPointsTo() {
  ...
  public RCUSearchState join(RCUSearchState pOther) throws CPAException, InterruptedException {
    ...
    try {
      Set<RCUMemoryLocation> pointers = new TreeSet<>(rcuPointers);
