...
import org.sosy_lab.cpachecker.cpa.racer.storage.RacerUnsafeDetector.UnsafeMode;

@Options(prefix = "cpa.racer")
public class RacerUsageConfiguration {
  ...
  public RacerUsageConfiguration(Configuration config) throws InvalidConfigurationException {
    config.inject(this);
  }
