...
public class RacerKleverErrorTracePrinterOld extends RacerErrorTracePrinter {

    public RacerKleverErrorTracePrinterOld(
            Configuration c,
    ...
    private void dumpCommonInfoForEdge(GraphMlBuilder builder, Element result, CFAEdge pEdge) {
        ...
        builder.addDataElementChild(result, KeyDef.ORIGINFILE,
            String.valueOf(location.getFileName()));
