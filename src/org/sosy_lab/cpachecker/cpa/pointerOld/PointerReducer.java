...
public class PointerReducer implements Reducer {
  ...
  public AbstractState getVariableReducedState(
    ...
    reduceTime.start();
    PointerState
        clonedState = (PointerState) expandedState;
    // Avoid ConcurrentModification
    for (RCUMemoryLocation ptr : new TreeSet<>(clonedState.getTrackedRCUMemoryLocations())) {
  ...
  public AbstractState getVariableExpandedState(
    ...
    expandTime.start();
    PointerState
        clonedState = (PointerState) rootState;
    for (RCUMemoryLocation ptr : ((PointerState) reducedState).getTrackedRCUMemoryLocations()) {
      clonedState =
          clonedState
