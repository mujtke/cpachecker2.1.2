 ...
 */
public class RacerPartitionedReachedSet extends RacerDefaultReachedSet {

  private final Multimap<Object, AbstractState> partitionedReached =
      LinkedHashMultimap.create(100, 1);

  public RacerPartitionedReachedSet(ConfigurableProgramAnalysis pCpa, WaitlistFactory waitlistFactory) {
