...
public class RacerIdentifierCreator extends DefaultCExpressionVisitor<AbstractIdentifier, NoException> {
  protected int dereference;
  protected String function;

  public RacerIdentifierCreator() {
  }

  public RacerIdentifierCreator(String func) {
    this();
  ...
  public RacerIdentifierCreator copy() {
    return new RacerIdentifierCreator();
  }
}
